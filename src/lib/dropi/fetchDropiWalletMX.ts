...
const DROPI_WALLET_URL = "https://api.dropi.mx/api/historywallet";
...
export type DropiWalletMovementMX = {
...
function mapWalletMovements(payload: unknown): DropiWalletMovementMX[] {
  const rows: DropiWalletMovementMX[] = [];
...
export async function fetchDropiWalletMX(token: string) {
